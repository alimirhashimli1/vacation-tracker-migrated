...
let HolidaysService = (() => {
    ...
    let _classThis;
    var HolidaysService = _classThis = class {
        ...
        isHoliday(date, region) {
            return __awaiter(this, void 0, void 0, function* () {
                const holiday = yield this.holidaysRepository.findOne({
                    where: [
                        { date, region },
        ...
        getHolidaysInRange(startDate, endDate, region) {
            return __awaiter(this, void 0, void 0, function* () {
                return this.holidaysRepository.find({
                    where: {
                        date: (0, typeorm_1.Between)(startDate, endDate),
                        region: (0, typeorm_1.In)([region, 'DE']), // Check for user's region and nationwide holidays
                    },
                    order: {
                        date: 'ASC',
                    }
    ...
    __setFunctionName(_classThis, "HolidaysService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        HolidaysService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return HolidaysService = _classThis;
})();
