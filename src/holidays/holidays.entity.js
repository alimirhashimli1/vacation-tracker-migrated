...
let Holiday = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('holidays')];
    ...
    var Holiday = _classThis = class {
        constructor() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.date = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _date_initializers, void 0));
            this.name = (__runInitializers(this, _date_extraInitializers), __runInitializers(this, _name_initializers, void 0));
    ...
    __setFunctionName(_classThis, "Holiday");
    (() => {
        ...
        Holiday = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Holiday = _classThis;
})();
