...
let HolidaySeeder = (() => {
    ...
    let _classThis;
    var HolidaySeeder = _classThis = class {
        constructor(holidaysService) {
            this.holidaysService = holidaysService;
            this.logger = new common_1.Logger(HolidaySeeder.name);
        }
        seed() {
                ...
                try {
                    ...
                    for (const holiday of holidays) {
                        ...
                        for (const region of regions) {
                            const existingHoliday = yield this.holidaysService.findOne(new Date(holiday.date), region);
                            if (!existingHoliday) {
                                ...
                                yield this.holidaysService.create(holidayEntity);
                            }
                        }
                    }
    ...
    __setFunctionName(_classThis, "HolidaySeeder");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        HolidaySeeder = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return HolidaySeeder = _classThis;
})();
