...
const public_decorator_1 = require("../../../../shared/auth/public.decorator");
...
let AuthController = (() => {
    ...
    var AuthController = _classThis = class {
        constructor(authService, invitationsService) {
        ...
        register(registerDto) {
            return __awaiter(this, void 0, void 0, function* () {
                const newUser = yield this.invitationsService.acceptInvitation(registerDto.token, registerDto.password, registerDto.firstName, registerDto.lastName);
    ...
    (() => {
        ...
        _register_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('register'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
