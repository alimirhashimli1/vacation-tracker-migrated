...
const update_user_dto_1 = require("../shared/update-user.dto");
let UsersController = class UsersController {
    ...
    async findOne(id, req) {
        ...
        if (!req.user.roles.includes(role_enum_1.Role.Admin) && req.user.id !== user.id) {
    ...
    async update(id, updateUserDto, req) {
        ...
        if (!req.user.roles.includes(role_enum_1.Role.Admin) && req.user.id !== id) {
