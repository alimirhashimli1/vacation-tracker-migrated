...
const create_invitation_dto_1 = require("../shared/create-invitation.dto");
...
let InvitationsController = class InvitationsController {
    ...
    async createInvitation(createInvitationDto, res, req) {
        const { invitation, plainToken } = await this.invitationsService.createInvitation(createInvitationDto.email, createInvitationDto.role, req.user.id);
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_invitation_dto_1.CreateInvitationDto, Object, Object]),
